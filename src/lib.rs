...
//!   a call to [`nih_export_vst3!()`], [`nih_export_clap!()`], and/or [`nih_export_au!()`] in your
//!   `lib.rs` file to expose the plugin functionality. Some of these traits will require you to
//!   implement an additional trait containing API-specific information for the plugin.
//!
